...
//	user test case
	...
	public static void selectTableGreaterThan(){
		System.out.println("Testing less than operator");
		executeStatement(new Select("contact",new String[]{"*"},new LessThan("id","50")));
	}
